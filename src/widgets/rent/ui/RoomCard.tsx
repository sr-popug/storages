  ...
  return (
    ...
    >
      <div className='text flex flex-col justify-between grow'>
        ...
        <Link
          href={`/rent/${room.id}`}
          className='mt-5 bg-red-800 py-1.5 rounded-full  flex  items-center justify-center  text-[15px] lg:text-base/7  text-nowrap transition-colors hover:bg-red-900 font-bold'
        >
          Арендовать
        </Link>
      </div>
